  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      >
        ...
        <Text style={styles.titulo}>📊 Relatório de Cancelamentos</Text>
        ...
        <View style={styles.resumoContainer}>
          <Text style={styles.resumoTexto}>💰 Total Cancelado: R$ {totalVendas.toFixed(2)}</Text>
        </View>

        {pedidos.length > 0 && (
          <View style={styles.graficoContainer}>
            <Text style={styles.subtitulo}>Cancelamentos</Text>
            <BarChart
              data={{
        ...
        <Text style={styles.subtitulo}>Últimos pedidos cancelados</Text>
        <FlatList
